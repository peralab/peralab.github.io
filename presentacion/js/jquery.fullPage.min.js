...
(function (b) {
    b.fn.fullpage = function (c) {
        function sa(a) {
            ...
            "#fff" != c.controlArrowColor &&
                (a.find(".fp-controlArrow.fp-next").css("border-color", "transparent transparent transparent " + c.controlArrowColor),
        ...
        function V() {
            ...
            if (!c.autoScrolling || c.scrollBar) {
                var d = b(window).scrollTop(),
                    e = 0,
                    f = Math.abs(d - b(".fp-section").first().offset().top);
                b(".fp-section").each(function (a) {
                    var c = Math.abs(d - b(this).offset().top);
                    c < f && ((e = a), (f = c));
                });
                a = b(".fp-section").eq(e);
            }
            if ((!c.autoScrolling || c.scrollBar) && !a.hasClass("active")) {
                H = !0;
                var g = b(".fp-section.active"),
                    n = g.index(".fp-section") + 1,
                    l = I(a),
                    A = a.data("anchor"),
                    h = a.index(".fp-section") + 1,
                    J = a.find(".fp-slide.active");
                if (J.length)
                    var m = J.data("anchor"),
                        k = J.index();
                a.addClass("active").siblings().removeClass("active");
                p || (b.isFunction(c.onLeave) && c.onLeave.call(g, n, h, l), b.isFunction(c.afterLoad) && c.afterLoad.call(a, A, h));
                K(A, 0);
                c.anchors.length && !p && ((q = A), L(k, m, A, h));
                clearTimeout(W);
            ...
            c.scrollBar &&
                ...
                (X = setTimeout(function () {
                    p || (b(".fp-section.active").is(a) && (v = !0), r(a), (v = !1));
                }, 1e3)));
        }
        function Y(a) {
        ...
        function B(a, d) {
            if (m[a]) {
                var c, f;
                "down" == a ? ((c = "bottom"), (f = b.fn.fullpage.moveSectionDown)) : ((c = "top"), (f = b.fn.fullpage.moveSectionUp));
                if (0 < d.length)
        ...
        function ua(a) {
            ...
            if (!Z(a.target)) {
                ...
                p ||
                    ...
                    (u = d.y),
                    (C = d.x),
                    a.find(".fp-slides").length && Math.abs(D - C) > Math.abs(x - u)
                        ? Math.abs(D - C) > (b(window).width() / 100) * c.touchSensitivity && (D > C ? m.right && b.fn.fullpage.moveSlideRight() : m.left && b.fn.fullpage.moveSlideLeft())
                        : c.autoScrolling && Math.abs(x - u) > (b(window).height() / 100) * c.touchSensitivity && (x > u ? B("down", e) : u > x && B("up", e)));
            }
        }
        function Z(a, d) {
            d = d || 0;
        ...
        function r(a, d, e) {
            ...
            if (
                ...
                !((d.activeSection.is(a) && !v) || (c.scrollBar && b(window).scrollTop() === d.dtop)))
            ) {
                if (d.activeSlide.length)
                    var g = d.activeSlide.data("anchor"),
                        n = d.activeSlide.index();
                c.autoScrolling &&
                    c.continuousVertical &&
                    "undefined" !== typeof d.isMovementUp &&
                    ((!d.isMovementUp && "up" == d.yMovement) || (d.isMovementUp && "down" == d.yMovement)) &&
                    (d.isMovementUp ? b(".fp-section.active").before(d.activeSection.nextAll(".fp-section")) : b(".fp-section.active").after(d.activeSection.prevAll(".fp-section").get().reverse()),
                    k(b(".fp-section.active").position().top),
                    ca(),
                    (d.wrapAroundElements = d.activeSection),
                    (d.dest = d.element.position()),
                    (d.dtop = d.dest.top),
                    (d.yMovement = I(d.element)));
                a.addClass("active").siblings().removeClass("active");
                p = !0;
                L(n, g, d.anchorLink, d.sectionIndex);
                b.isFunction(c.onLeave) && !d.localIsResizing && c.onLeave.call(d.activeSection, d.leavingSection, d.sectionIndex + 1, d.yMovement);
                wa(d);
                q = d.anchorLink;
                c.autoScrolling && K(d.anchorLink, d.sectionIndex);
            }
        }
        function wa(a) {
            if (c.css3 && c.autoScrolling && !c.scrollBar)
                da("translate3d(0px, -" + a.dtop + "px, 0px)", !0),
                    setTimeout(function () {
                        ea(a);
                    }, c.scrollingSpeed);
            else {
                var d = xa(a);
                b(d.element)
                    .animate(d.options, c.scrollingSpeed, c.easing)
                    .promise()
                    .done(function () {
                        ea(a);
                    });
        ...
        function xa(a) {
            var b = {};
            c.autoScrolling && !c.scrollBar ? ((b.options = { top: -a.dtop }), (b.element = "." + fa)) : ((b.options = { scrollTop: a.dtop }), (b.element = "html, body"));
            return b;
        }
        function ya(a) {
            a.wrapAroundElements && a.wrapAroundElements.length && (a.isMovementUp ? b(".fp-section:first").before(a.wrapAroundElements) : b(".fp-section:last").after(a.wrapAroundElements), k(b(".fp-section.active").position().top), ca());
        }
        function ea(a) {
            ya(a);
            b.isFunction(c.afterLoad) && !a.localIsResizing && c.afterLoad.call(a.element, a.anchorLink, a.sectionIndex + 1);
            setTimeout(function () {
                p = !1;
            ...
            if (!H) {
                ...
                if (b.length) {
                    var c = "undefined" === typeof q,
                        f = "undefined" === typeof q && "undefined" === typeof a && !w;
                    ((b && b !== q && !c) || f || (!w && N != a)) && O(b, a);
                }
            }
        }
        function y(a, d) {
            var e = d.position(),
                ...
                g = d.index(),
                n = a.closest(".fp-section"),
                h = n.index(".fp-section"),
                l = n.data("anchor"),
                m = n.find(".fp-slidesNav"),
                k = d.data("anchor"),
                p = v;
            if (c.onSlideLeave) {
                var r = n.find(".fp-slide.active"),
                    q = r.index(),
                    t;
                t = q == g ? "none" : q > g ? "left" : "right";
                p || "none" === t || (b.isFunction(c.onSlideLeave) && c.onSlideLeave.call(r, l, h + 1, q, t));
            }
            d.addClass("active").siblings().removeClass("active");
            "undefined" === typeof k && (k = g);
            !c.loopHorizontal && c.controlArrows && (n.find(".fp-controlArrow.fp-prev").toggle(0 != g), n.find(".fp-controlArrow.fp-next").toggle(!d.is(":last-child")));
            n.hasClass("active") && L(g, k, l, h);
            var u = function () {
                p || (b.isFunction(c.afterSlideLoad) && c.afterSlideLoad.call(d, l, h + 1, k, g));
                w = !1;
            };
            c.css3
                ? ((e = "translate3d(-" + e.left + "px, 0px, 0px)"),
                  ha(a.find(".fp-slidesContainer"), 0 < c.scrollingSpeed).css(ia(e)),
                  setTimeout(
                      function () {
                          u();
                      },
                ...
                : f.animate({ scrollLeft: e.left }, c.scrollingSpeed, c.easing, function () {
                      u();
                  });
            m.find(".active").removeClass("active");
            m.find("li").eq(g).find("a").addClass("active");
        }
        function ja() {
            ka();
            if (E) {
                if ("text" !== b(document.activeElement).attr("type")) {
                    ...
                    Math.abs(a - P) > (20 * Math.max(P, a)) / 100 && (b.fn.fullpage.reBuild(!0), (P = a));
                }
            } else
                clearTimeout(la),
        ...
        function ka() {
            if (c.responsive) {
                ...
                b(window).width() < c.responsive
                    ? a || (b.fn.fullpage.setAutoScrolling(!1, "internal"), b("#fp-nav").hide(), g.addClass("fp-responsive"))
                    : a && (b.fn.fullpage.setAutoScrolling(Q.autoScrolling, "internal"), b("#fp-nav").show(), g.removeClass("fp-responsive"));
            }
        }
        function ha(a) {
        ...
        function K(a, d) {
            c.menu &&
                (b(c.menu).find(".active").removeClass("active"),
                b(c.menu)
                    .find('[data-menuanchor="' + a + '"]')
                    .addClass("active"));
            c.navigation &&
                (b("#fp-nav").find(".active").removeClass("active"),
                a
                    ? b("#fp-nav")
                          .find('a[href="#' + a + '"]')
                          .addClass("active")
                    : b("#fp-nav").find("li").eq(d).find("a").addClass("active"));
        }
        function I(a) {
        ...
        function z(a) {
            ...
            var b = a.closest(".fp-section"),
                ...
                f;
            e.length ? (f = e.get(0).scrollHeight) : ((f = a.get(0).scrollHeight), c.verticalCentered && (f = a.find(".fp-tableCell").get(0).scrollHeight));
            b = l - parseInt(b.css("padding-bottom")) - parseInt(b.css("padding-top"));
            f > b
                ? e.length
                    ? e
                          .css("height", b + "px")
                          .parent()
                          .css("height", b + "px")
                    : (c.verticalCentered ? a.find(".fp-tableCell").wrapInner('<div class="fp-scrollable" />') : a.wrapInner('<div class="fp-scrollable" />'),
                      a.find(".fp-scrollable").slimScroll({ allowPageScroll: !0, height: b + "px", size: "10px", alwaysVisible: !0 }))
                : ma(a);
            a.css("overflow", "");
        }
        function ma(a) {
        ...
        function na(a) {
            a.addClass("fp-table").wrapInner('<div class="fp-tableCell" style="height:' + oa(a) + 'px;" />');
        }
        function oa(a) {
            var b = l;
            if (c.paddingTop || c.paddingBottom) (b = a), b.hasClass("fp-section") || (b = a.closest(".fp-section")), (a = parseInt(b.css("padding-top")) + parseInt(b.css("padding-bottom"))), (b = l - a);
            return b;
        }
        function da(a, b) {
            b ? ha(g) : R(g);
        ...
        function O(a, d) {
            ...
            c = isNaN(a) ? b('[data-anchor="' + a + '"]') : b(".fp-section").eq(a - 1);
            a === q || c.hasClass("active")
                ? pa(c, d)
                : r(c, function () {
                      pa(c, d);
                  });
        ...
        function L(a, b, e, f) {
            var g = "";
            c.anchors.length
                ? (a ? ("undefined" !== typeof e && (g = e), "undefined" === typeof b && (b = a), (N = b), qa(g + "/" + b)) : ("undefined" !== typeof a && (N = b), qa(e)), F(location.hash))
                : "undefined" !== typeof a
                ? F(f + "-" + a)
                : F(String(f));
        }
        function qa(a) {
            ...
            else if (E || S) history.replaceState(void 0, void 0, "#" + a);
            else {
        ...
        function Ca() {
            if (E || S) {
                ...
                b(document)
                    ...
                    .on("touchstart " + a.down, va);
                b(document)
                    .off("touchmove " + a.move)
                    .on("touchmove " + a.move, ua);
            }
        }
        function Da() {
            if (E || S) {
                var a = ra();
                b(document).off("touchstart " + a.down);
                b(document).off("touchmove " + a.move);
            }
        }
        function ra() {
        ...
        function M(a) {
            ...
            y(a.closest(".fp-slides"), a);
            b.fn.fullpage.setScrollingSpeed(Q.scrollingSpeed, "internal");
        }
        function k(a) {
            c.scrollBar ? g.scrollTop(a) : c.css3 ? da("translate3d(0px, -" + a + "px, 0px)", !1) : g.css("top", -a);
        }
        function ia(a) {
        ...
        (function () {
            c.continuousVertical && (c.loopTop || c.loopBottom) && ((c.continuousVertical = !1), G("warn", "Option `loopTop/loopBottom` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled"));
            c.continuousVertical && c.scrollBar && ((c.continuousVertical = !1), G("warn", "Option `scrollBar` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled"));
            b.each(c.anchors, function (a, c) {
                (b("#" + c).length || b('[name="' + c + '"]').length) && G("error", "data-anchor tags can not have the same value as any `id` element on the site (or `name` element for IE).");
            });
        })();
        b.extend(b.easing, {
        ...
        b.fn.fullpage.setAutoScrolling = function (a, d) {
            ...
            c.autoScrolling && !c.scrollBar
                ? (b("html, body").css({ overflow: "hidden", height: "100%" }), b.fn.fullpage.setRecordHistory(c.recordHistory, "internal"), g.css({ "-ms-touch-action": "none", "touch-action": "none" }), e.length && k(e.position().top))
                : (b("html, body").css({ overflow: "visible", height: "initial" }), b.fn.fullpage.setRecordHistory(!1, "internal"), g.css({ "-ms-touch-action": "", "touch-action": "" }), k(0), b("html, body").scrollTop(e.position().top));
        };
        ...
        b.fn.fullpage.setMouseWheelScrolling = function (a) {
            a
                ? document.addEventListener
                    ? (document.addEventListener("mousewheel", t, !1), document.addEventListener("wheel", t, !1))
                    : document.attachEvent("onmousewheel", t)
                : document.addEventListener
                ? (document.removeEventListener("mousewheel", t, !1), document.removeEventListener("wheel", t, !1))
                : document.detachEvent("onmousewheel", t);
        };
        b.fn.fullpage.setAllowScrolling = function (a, c) {
            "undefined" != typeof c
                ...
                : a
                ? (b.fn.fullpage.setMouseWheelScrolling(!0), Ca())
                : (b.fn.fullpage.setMouseWheelScrolling(!1), Da());
        };
        ...
        b.fn.fullpage.moveTo = function (a, c) {
            ...
            "undefined" !== typeof c ? O(a, c) : 0 < e.length && r(e);
        };
        ...
        b.fn.fullpage.reBuild = function (a) {
            ...
            c.resize && za(l, d);
            b(".fp-section").each(function () {
                var a = b(this).find(".fp-slides"),
                    d = b(this).find(".fp-slide");
                c.verticalCentered &&
                    b(this)
                        .find(".fp-tableCell")
                        .css("height", oa(b(this)) + "px");
                b(this).css("height", l + "px");
                c.scrollOverflow &&
                    (d.length
                        ? d.each(function () {
                              z(b(this));
                        ...
                        : z(b(this)));
                d.length && y(a, a.find(".fp-slide.active"));
            });
            d = b(".fp-section.active");
            d.index(".fp-section") && r(d);
            v = !1;
            b.isFunction(c.afterResize) && a && c.afterResize.call(g);
            b.isFunction(c.afterReBuild) && !a && c.afterReBuild.call(g);
        };
        var w = !1,
            E = navigator.userAgent.match(/(iPhone|iPod|iPad|Android|BlackBerry|BB10|Windows Phone|Tizen|Bada)/),
            S = "ontouchstart" in window || 0 < navigator.msMaxTouchPoints || navigator.maxTouchPoints,
            g = b(this),
            l = b(window).height(),
            p = !1,
            v = !1,
            ...
            h,
            fa = "fullpage-wrapper",
            m = { up: !0, down: !0, left: !0, right: !0 },
            Q = b.extend(!0, {}, c);
        b.fn.fullpage.setAllowScrolling(!0);
        c.css3 && (c.css3 = Ba());
        b(this).length ? (g.css({ height: "100%", position: "relative" }), g.addClass(fa)) : G("error", "Error! Fullpage.js needs to be initialized with a selector. For example: $('#myContainer').fullpage();");
            ...
            .each(function (a) {
                ...
                if (1 < f) {
                    ...
                    b(this)
                        ...
                        .css("width", a + "%");
                    c.controlArrows && sa(b(this));
                    c.slidesNavigation && Aa(b(this), f);
                    e.each(function (a) {
                        b(this).css("width", g + "%");
                        c.verticalCentered && na(b(this));
                    });
                    d = d.find(".fp-slide.active");
                    d.length ? M(d) : e.eq(0).addClass("active");
                } else c.verticalCentered && na(b(this));
            })
            .promise()
            .done(function () {
                b.fn.fullpage.setAutoScrolling(c.autoScrolling, "internal");
                var a = b(".fp-section.active").find(".fp-slide.active");
                a.length && (0 !== b(".fp-section.active").index(".fp-section") || (0 === b(".fp-section.active").index(".fp-section") && 0 !== a.index())) && M(a);
                c.fixedElements && c.css3 && b(c.fixedElements).appendTo("body");
                c.navigation && (h.css("margin-top", "-" + h.height() / 2 + "px"), h.find("li").eq(b(".fp-section.active").index(".fp-section")).find("a").addClass("active"));
                c.menu && c.css3 && b(c.menu).closest(".fullpage-wrapper").length && b(c.menu).appendTo("body");
                c.scrollOverflow ? ("complete" === document.readyState && U(), b(window).on("load", U)) : b.isFunction(c.afterRender) && c.afterRender.call(g);
                ka();
                ...
                if (a.length) {
                    ...
                    !c.animateAnchor &&
                        d.length &&
                        (c.autoScrolling ? k(d.position().top) : (k(0), F(a), b("html, body").scrollTop(d.position().top)),
                        K(a, null),
                        b.isFunction(c.afterLoad) && c.afterLoad.call(d, a, d.index(".fp-section") + 1),
                        d.addClass("active").siblings().removeClass("active"));
                }
        ...
        var W,
            X,
            H = !1;
        b(window).on("scroll", V);
        var x = 0,
            D = 0,
            u = 0,
            C = 0;
        b(window).on("hashchange", ga);
        b(document).keydown(function (a) {
            if (c.keyboardScrolling && c.autoScrolling && ((40 != a.which && 38 != a.which) || a.preventDefault(), !p))
                switch (a.which) {
                    case 38:
                    case 33:
        ...
        c.normalScrollElements &&
            (b(document).on("mouseenter", c.normalScrollElements, function () {
        ...
        b.fn.fullpage.destroy = function (a) {
            ...
            b(window).off("scroll", V).off("hashchange", ga).off("resize", ja);
